...
- Name: 10-multi-role-journey.spec.ts >> 10 — Jornada multi-perfil (cliente → pintor → clube) >> Fase 3C — DB: ativar Clube e verificar ferramentas desbloqueadas
- Location: e2e/10-multi-role-journey.spec.ts:380:3
...
Locator: locator('text=/Toque para enviar|enviar foto do ambiente/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Toque para enviar|enviar foto do ambiente/i').first()

```

```yaml
- heading "Ferramentas" [level=1]
- paragraph: Recursos gratuitos e exclusivos para sua pintura.
- paragraph: Ferramentas gratuitas
- button "Estimativa de Orçamento IA Gratuito Calcule o valor estimado do serviço em segundos com base em m², tipo e condição das paredes.":
  - paragraph: Estimativa de Orçamento IA
  - text: Gratuito
  - paragraph: Calcule o valor estimado do serviço em segundos com base em m², tipo e condição das paredes.
- text: Tipo de serviço
- combobox:
  - option "Pintura interna" [selected]
  - option "Pintura externa"
  - option "Fachada"
  - option "Textura"
  - option "Pós-obra"
  - option "Arte / mural"
  - option "Impermeabilização"
- text: Condição das paredes
- combobox:
  - option "Repintura simples" [selected]
  - option "Pequenas manchas"
  - option "Furos leves"
  - option "Mofo ou umidade"
  - option "Infiltração"
- text: Área total (m²)
- spinbutton
- checkbox "Incluir material (tinta + massa)"
- text: Incluir material (tinta + massa)
- paragraph: Informe a área para calcular
- button "Calculadora de Tinta Gratuito Descubra quantos litros de tinta comprar, quantas demãos aplicar e o custo por m². Abrir":
  - paragraph: Calculadora de Tinta
  - text: Gratuito
  - paragraph: Descubra quantos litros de tinta comprar, quantas demãos aplicar e o custo por m².
  - link "Abrir":
    - /url: /calculadora
- button "Visualizador de Cores Gratuito Experimente centenas de cores nas suas paredes antes de decidir — sem precisar pintar. Abrir":
  - paragraph: Visualizador de Cores
  - text: Gratuito
  - paragraph: Experimente centenas de cores nas suas paredes antes de decidir — sem precisar pintar.
  - link "Abrir":
    - /url: /visualizar-cor
- paragraph: Clube Pinte Rápido
- button "Prévia com IA Clube Envie uma foto do ambiente e veja como ficará pintado antes mesmo de contratar.":
  - paragraph: Prévia com IA
  - text: Clube
  - paragraph: Envie uma foto do ambiente e veja como ficará pintado antes mesmo de contratar.
- paragraph: Transforme fotos em visualizações realistas com IA. Disponível para membros do Clube.
- link "Assinar Clube":
  - /url: /clube
- paragraph: Clube Pinte Rápido
- paragraph:
  - text: Prévia com IA, pintores parceiros certificados, descontos em materiais e acompanhamento exclusivo da equipe.
  - strong: R$49/mês — 10 créditos de IA inclusos.
- link "Conhecer o Clube":
  - /url: /clube
- img "Exemplo de prévia com IA"
- paragraph: Exemplo de prévia gerada por IA Exclusivo para membros do Clube
