  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Gestão do plano Pintaê Pro</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
          ...
          <p className="text-xs text-gray-300 mt-1">As assinaturas do plano Pintaê Pro aparecerão aqui.</p>
        </div>
      ) : (
